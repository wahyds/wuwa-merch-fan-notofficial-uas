// 💛 Talent3Page.js - Carthethyia (Blonde to White Gradient with Banner Background)
...
const defaultProducts = [
  ...
  { id: 3, name: 'Carthethyia Figure Esklusif', price: 250000, image: '/Figure.jpg', stock: 10 }
]
...
export default function Talent3Page() {
  ...
  return (
    <div className="min-h-screen p-6" style={{ background: 'linear-gradient(to bottom, #f9e79f, white)' }}>
      <button onClick={() => router.push('/Dashboard')} className="mb-4 inline-flex items-center gap-2 text-white bg-yellow-700 hover:bg-yellow-800 px-4 py-2 rounded-full shadow">
